#!/usr/bin/env python3
"""WP-U3: swarm size S atlas for Unary link Swarm."""
...
from width_grid import DEFAULT_WIDTHS, parse_widths  # noqa: E402

EXPERIMENT_ID = "v0_10_unary_width"


def main() -> None:
    parser = argparse.ArgumentParser(description="v0_10 unary width atlas")
    ...
    # Adam default lr if user left sgd default while choosing adam
    lr = args.lr
    ...
    # Plateau note: best S among finished cells
    ...
    payload = {
        ...
        "best_cell": best,
        "note": (
            "Unary link Swarm (XOR writeback). Do not merge with v0_5_width_unary "
            "without an explicit dual-axis label."
        ),
    }
    ...
    if best:
        print(f"Peak sample: S={best['S']} acc={best['best_test_acc']:.4f}")
